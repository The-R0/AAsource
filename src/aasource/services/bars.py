...
from aasource.domain.batch import resolve_inputs, unique_symbols
from aasource.domain.enums import AdjustMode, BarStatus, Timeframe
...
from aasource.domain.validators import assert_supported_adjust
from aasource.normalize.bars import bars_from_daily_frame, bars_from_minute_rows, resample_bars
from aasource.normalize.daily import normalize_daily
from aasource.normalize.validation import annotate_bar_quality
...
def get_bars(
    ...
    *,
    ...
    if is_sector_id(symbol):
        ...
        if tf == Timeframe.D1:
            from aasource.providers.eastmoney_boards import fetch_sector_daily
        ...
        from aasource.services.sectors import sector_minute
